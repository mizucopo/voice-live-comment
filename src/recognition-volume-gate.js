export const DEFAULT_RECOGNITION_VOLUME_THRESHOLD = 0.08;
export const MIN_RECOGNITION_VOLUME_THRESHOLD = 0.01;
...
export function normalizeRecognitionVolumeThreshold(value) {
  ...
  const clamped = Math.min(
    ...
    Math.max(MIN_RECOGNITION_VOLUME_THRESHOLD, numberValue)
  );
